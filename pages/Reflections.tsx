    ...
    <div className="pt-32 pb-24 bg-slate-200 dark:bg-slate-950 transition-colors duration-300 min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-24 relative">
          {/* Timeline Connector */}
          <div className="absolute left-1/2 top-0 bottom-0 w-px bg-slate-300 dark:bg-slate-800 hidden lg:block -translate-x-1/2"></div>
             ...
             return (
               ...
               >
                 ...
                 <div className="w-full lg:w-3/5 group">
                   <div className="relative p-10 md:p-14 bg-slate-100/80 dark:bg-slate-900 border border-slate-300 dark:border-slate-800 rounded-[50px] shadow-sm group-hover:shadow-2xl transition-all duration-700 overflow-hidden backdrop-blur-sm">
                      ...
                      <div className="relative z-10 text-left">
                        ...
                        <div className="text-slate-800 dark:text-slate-300 text-lg md:text-xl leading-relaxed italic font-medium mb-12 font-serif whitespace-pre-wrap">
                          "{journalText}"
                        </div>
                 ...
                 <div className="w-full lg:w-2/5 flex flex-col items-center lg:items-start text-center lg:text-left">
                   <div className="relative mb-8">
                     ...
                     <div className="relative w-32 h-32 md:w-48 md:h-48 rounded-[40px] overflow-hidden border-8 border-slate-100 dark:border-slate-800 shadow-2xl transform group-hover:rotate-3 transition-transform duration-500">
                        <img 
                          src={member.image} 
                          alt={member.name} 
                 ...
                 {/* Desktop Center Dot */}
                 <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-blue-600 rounded-full border-4 border-slate-200 dark:border-slate-950 shadow-lg hidden lg:block z-20"></div>
               </div>
             );
          })}
        </div>
