...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen transition-colors duration-300 bg-slate-200 dark:bg-slate-950">
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center pt-24 overflow-hidden hero-pattern">
        <div className="absolute inset-0 z-0 opacity-[0.06] dark:opacity-[0.1] grayscale pointer-events-none">
          <img 
        ...
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-300/20 dark:bg-blue-900/20 rounded-full blur-[120px] opacity-40 -mr-48 -mt-48 animate-pulse"></div>
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-indigo-300/20 dark:bg-indigo-900/20 rounded-full blur-[100px] opacity-30 -ml-24 -mb-24"></div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 text-left">
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-slate-300/80 dark:bg-blue-900/30 border border-slate-400/50 dark:border-blue-800/50 rounded-full mb-8 animate-fade-in shadow-sm">
                <span className="w-2.5 h-2.5 bg-blue-600 rounded-full animate-ping"></span>
                <span className="text-[10px] font-black text-slate-800 dark:text-blue-300 uppercase tracking-[0.2em]">S.C.A.A.M Impact</span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-slate-700 dark:text-gray-400 mb-12 leading-relaxed max-w-xl font-medium text-left">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <Link 
                  to="/reviews" 
                  className="bg-white/90 dark:bg-slate-800/70 backdrop-blur-xl text-slate-900 dark:text-white px-10 py-5 rounded-[24px] text-[13px] font-black uppercase tracking-widest shadow-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-all text-center border border-slate-300 active:scale-95"
                >
                  Our Story
                </Link>
              </div>
            ...
            <div className="lg:col-span-5 relative hidden lg:block">
              <div className="relative">
                <div className="relative w-full max-w-[450px] mx-auto aspect-[4/5] rounded-[48px] overflow-hidden border-[12px] border-slate-100 dark:border-slate-800 shadow-2xl ring-1 ring-slate-300 dark:ring-slate-700 transform rotate-2">
                  <img 
      ...
      <section id="mission-statement-info" className="py-24 bg-slate-300/40 dark:bg-slate-900/50 text-left transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl text-left">
             ...
             <div className="space-y-8">
               <p className="text-slate-700 dark:text-gray-400 text-lg md:text-xl font-medium leading-relaxed max-w-4xl">
      ...
      {/* Team Section */}
      <section className="py-24 bg-slate-200 dark:bg-black text-left transition-colors duration-300 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
            ...
            <Link to="/reviews" className="px-10 py-5 bg-slate-300/50 dark:bg-slate-900 text-slate-900 dark:text-white font-black text-[13px] uppercase tracking-[0.2em] rounded-2xl hover:bg-blue-600 hover:text-white transition-all shadow-xl active:scale-95 border border-slate-400/50 dark:border-white/5">
              Our Story
            </Link>
          </div>
