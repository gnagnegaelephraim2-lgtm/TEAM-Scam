    ...
    <div className="pt-32 pb-24 bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
        <header className="mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-gray-900 mb-8 tracking-tighter text-left">
        ...
        <div className="prose prose-blue max-w-none text-gray-600 font-medium leading-relaxed space-y-8">
          <section>
            <h3 className="text-2xl font-black text-gray-900 mb-4 tracking-tight">Mission Integrity & Data Ethics</h3>
            <p>
          ...
          <section>
            <h3 className="text-2xl font-black text-gray-900 mb-4 tracking-tight">Data Collection Scope</h3>
            <p>
          ...
          <section>
            <h3 className="text-2xl font-black text-gray-900 mb-4 tracking-tight">Regional Compliance</h3>
            <p>
          ...
          <section className="bg-slate-50 p-8 rounded-[40px] border border-slate-100 mt-12">
            <h4 className="text-gray-950 font-black mb-2">Transparency Note</h4>
