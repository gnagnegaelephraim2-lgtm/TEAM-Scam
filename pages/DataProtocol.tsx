      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
        ...
        <div className="prose prose-blue max-w-none text-slate-600 dark:text-gray-400 font-medium leading-relaxed space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-8 rounded-[40px] border border-blue-100 dark:border-blue-800/50">
              <h4 className="text-blue-900 dark:text-blue-400 font-black mb-2 uppercase tracking-widest text-xs">Encryption Standard</h4>
              <p className="text-sm text-blue-800 dark:text-blue-300/80">AES-256 bit encryption at rest for all competency verification records.</p>
            </div>
            <div className="bg-white/50 dark:bg-slate-900 p-8 rounded-[40px] border border-slate-200 dark:border-slate-800 shadow-sm">
