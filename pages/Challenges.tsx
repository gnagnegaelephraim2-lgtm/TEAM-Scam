            ...
            >
              <div className="w-full lg:w-5/12 sticky top-32">
                <div className="relative group">
                  ...
                  <div className="relative aspect-[4/3] overflow-hidden rounded-[40px] border-[8px] border-slate-200 dark:border-slate-800 shadow-xl ring-1 ring-slate-400 dark:ring-slate-700">
                    <img 
                      src={challenge.image} 
                      alt={challenge.title} 
              ...
              <div className="w-full lg:w-7/12 text-left">
                ...
                <div className="space-y-6 text-slate-900 dark:text-gray-400 leading-relaxed font-medium text-base">
                  <p>{challenge.description}</p>
                </div>
                
                <div className="mt-10 bg-slate-100/80 dark:bg-slate-900 p-8 rounded-[40px] border border-slate-400 dark:border-slate-800 relative overflow-hidden group/card transition-colors shadow-sm">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-slate-950 dark:text-white font-bold italic text-lg leading-relaxed">
                      "{challenge.impact}"
                    </p>
                  </div>
                </div>
