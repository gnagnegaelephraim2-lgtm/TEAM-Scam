...
export const TEAM_MEMBERS: TeamMember[] = [
  ...
  },
  {
    ...
    reflection: "I went into ALCHE thinking it would be all about programming and technical skills, but then I discovered E-Lab, and I was like, 'Huh, what is this?' However, my initial thought about what the course was about was proven wrong.",
    journal: "I went into ALCHE thinking it would be all about programming and technical skills, but then I discovered E-Lab, and I was like, 'Huh, what is this?' However, my initial thought about what the course was about was proven wrong. \n\nE-Lab has been a course that has brought about a lot of growth with regard to mindset when it comes to entrepreneurial opportunities, how to analyze, break down, and find the root cause of a problem, and come up with a sustainable, scalable solution that works to solve or aid in solving the problem. \n\nI have thoroughly enjoyed E-Lab; the facilitator has been very vibrant and enthusiastic about the course and coursework, ensuring that students acquire the concepts, skills, and mindset necessary for success in potential entrepreneurial projects they intend to undertake. It has been a good experience so far, and I intend to sharpen and utilize the skills acquired to make a lasting impact on the continent of Africa and the world at large.",
...
export const CHALLENGES: Challenge[] = [
  ...
  },
  {
    ...
    impact: "We had to use our storytelling skills to create a compelling pitch and proposal. This challenge brought us closer as a team as we gained a deeper understanding of the intricacies of solution development.",
